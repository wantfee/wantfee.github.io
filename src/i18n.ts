...
const resources = {
  ...
  zh: {
    translation: {
      ...
      personalIntro: '你好！我是JeffWang。一名拥有超过10年经验的UI/UX设计师和Web开发者，专注于创造用户体验优秀且视觉震撼的界面。我致力于将设计思维与技术实现相结合，为客户提供从概念到产品的完整解决方案。',
      codeObsession: '为了将静态界面转化为真实产品，我对代码有着执着的追求。现在作为一名Web开发者，我能够流畅地将设计转化为真实的产品。',
      learnMore: '了解更多',
      experience: '经验',
      years: '年',
